...
require (
	...
	github.com/OperatorFoundation/shapeshifter-transports/transports/Dust/v3 v3.0.4
	github.com/OperatorFoundation/shapeshifter-transports/transports/Optimizer/v3 v3.0.4
	github.com/OperatorFoundation/shapeshifter-transports/transports/Replicant/v3 v3.0.4
	github.com/OperatorFoundation/shapeshifter-transports/transports/meeklite/v3 v3.0.4
	github.com/OperatorFoundation/shapeshifter-transports/transports/meekserver/v3 v3.0.4
