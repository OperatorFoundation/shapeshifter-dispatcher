...
require (
	...
	github.com/OperatorFoundation/shapeshifter-transports/transports/Dust/v2 v2.2.5
	github.com/OperatorFoundation/shapeshifter-transports/transports/Optimizer/v2 v2.2.5
	github.com/OperatorFoundation/shapeshifter-transports/transports/Replicant/v2 v2.2.5
	github.com/OperatorFoundation/shapeshifter-transports/transports/meeklite/v2 v2.2.5
	github.com/OperatorFoundation/shapeshifter-transports/transports/meekserver/v2 v2.2.5
