...
~/go/bin/shapeshifter-dispatcher -udp -client -state state -target 127.0.0.1:2222 -transports shadow -proxylistenaddr 127.0.0.1:1443 -optionsFile ../../ConfigFiles/shadowClientChaCha.json -logLevel DEBUG -enableLogging &
