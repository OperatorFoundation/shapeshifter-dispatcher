...
FILENAME=testSocksTCPDustOutput.txt
...
~/go/bin/shapeshifter-dispatcher -server -state state -orport 127.0.0.1:3333 -transports dust -optionsFile ../../ConfigFiles/ dustServer.json -logLevel DEBUG -enableLogging &
