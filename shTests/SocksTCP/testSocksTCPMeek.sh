...
~/go/bin/shapeshifter-dispatcher -server -state state -orport 127.0.0.1:3333 -transports meekserver -optionsFile ../../ConfigFiles/ meek.json -logLevel DEBUG -enableLogging &
