...
~/go/bin/shapeshifter-dispatcher -server -state "$STATEPATH" -target 127.0.0.1:3333 -bindaddr obfs4-127.0.0.1:2222 -transports ../../ConfigFiles/obfs4 -logLevel DEBUG -enableLogging &
