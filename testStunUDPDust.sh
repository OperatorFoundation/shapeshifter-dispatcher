...
./shapeshifter-dispatcher -udp -server -state state -orport 127.0.0.1:3333 -transports dust -bindaddr dust-127.0.0.1:2222 -optionsFile dustServer.json -logLevel DEBUG -enableLogging &
