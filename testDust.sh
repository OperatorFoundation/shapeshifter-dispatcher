...
./shapeshifter-dispatcher -transparent -client -state state -target 127.0.0.1:2222 -transports dust -proxylistenaddr 127.0.0.1:1443 -optionsFile dustClient.json -logLevel DEBUG -enableLogging &
